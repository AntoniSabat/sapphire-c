...
var w = function(n2) {
  var r2 = n2.audience, h2 = n2.scope, v2 = n2.clientId, w2 = n2.children, b = n2.domain, m = n2.isDangerouslyUseLocalStorage, k = void 0 !== m && m, O = n2.redirectUri, I = n2.onRedirectCallback, _ = void 0 === I ? y : I, U = n2.logoutUri, F = (0, import_react.useState)(), P = F[0], R = F[1], S = (0, import_react.useReducer)(p, g), T = S[0], E = S[1];
    ...
    try {
      l(void 0, void 0, void 0, function() {
        ...
        return f(this, function(n3) {
          switch (n3.label) {
            case 0:
              return [4, createKindeClient({ audience: r2, scope: h2, client_id: v2, domain: b, is_dangerously_use_local_storage: k, redirect_uri: O, logout_uri: U, on_redirect_callback: _, _framework: "React", _frameworkVersion: "3.0.28" })];
            case 1:
              return e2 = n3.sent(), R(e2), [2];
          }
        });
      });
    } catch (e2) {
  ...
  }, [r2, h2, v2, b, k, O, U]), (0, import_react.useEffect)(function() {
    var e2 = true;
    return function() {
      if (P && e2)
        try {
          var n3 = P.getUser();
          E({ type: "INITIALISED", user: n3 });
        } catch (e3) {
          console.log(e3), E({ type: "ERROR", error: "login error" });
        }
    }(), function() {
      e2 = false;
    };
  ...
  var L = (0, import_react.useCallback)(function(e2) {
    return P.login(e2);
  }, [P]), x = (0, import_react.useCallback)(function(e2) {
    return P.register(e2);
  }, [P]), A = (0, import_react.useCallback)(function() {
    return P.logout();
  }, [P]), z = (0, import_react.useCallback)(function(e2, n3) {
    return P.getClaim(e2, n3);
  }, [P]), j = (0, import_react.useCallback)(function(e2, n3, r3) {
    return P.getFlag(e2, n3, r3);
  }, [P]), B = (0, import_react.useCallback)(function(e2, n3) {
    return P.getBooleanFlag(e2, n3);
  }, [P]), C = (0, import_react.useCallback)(function(e2, n3) {
    return P.getIntegerFlag(e2, n3);
  }, [P]), D = (0, import_react.useCallback)(function(e2, n3) {
    return P.getStringFlag(e2, n3);
  }, [P]), G = (0, import_react.useCallback)(function() {
    return P.getPermissions();
  }, [P]), K = (0, import_react.useCallback)(function(e2) {
    return P.getPermission(e2);
  }, [P]), N = (0, import_react.useCallback)(function() {
    return P.getOrganization();
  }, [P]), V = (0, import_react.useCallback)(function() {
    return P.getUserOrganizations();
  }, [P]), q = (0, import_react.useCallback)(function(e2) {
    return P.createOrg(e2);
  }, [P]), H = (0, import_react.useCallback)(function() {
    return l(void 0, void 0, void 0, function() {
      var e2, n3;
      return f(this, function(r3) {
        switch (r3.label) {
          case 0:
            return r3.trys.push([0, 2, , 3]), [4, P.getToken()];
          case 1:
    ...
    return l(void 0, void 0, void 0, function() {
      ...
      return f(this, function(r3) {
        switch (r3.label) {
          case 0:
            return r3.trys.push([0, 2, , 3]), [4, P.getIdToken()];
          case 1:
            return e2 = r3.sent(), [3, 3];
          case 2:
            throw n3 = r3.sent(), console.error(n3);
  ...
  }, [P]), M = (0, import_react.useCallback)(function() {
    return P.getUser();
  }, [P]), Q = (0, import_react.useMemo)(function() {
    return s(s({}, T), { getToken: H, getIdToken: J, login: L, register: x, logout: A, createOrg: q, getBooleanFlag: B, getClaim: z, getFlag: j, getIntegerFlag: C, getPermissions: G, getPermission: K, getOrganization: N, getStringFlag: D, getUserOrganizations: V, getUser: M });
  }, [T, H, J, L, x, A, q, z, G, K, N, V, M]);
  return import_react.default.createElement(d.Provider, { value: Q }, w2);
};
export {
  w as KindeProvider,
  h as useKindeAuth
