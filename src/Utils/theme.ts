...
export const customTheme: CustomFlowbiteTheme ={
    navbar: {
        "link": {
            ...
            "active": {
                "on": "bg-primary text-white dark:text-white md:bg-transparent md:text-secondary",
    ...
    button: {
        ...
        "fullSized": "w-full",
        "color": {
            "primary": "border border-transparent bg-primary text-white focus:ring-4 focus:ring-secondary enabled:hover:bg-secondary dark:bg-primary-600 dark:focus:ring-primary-800 dark:enabled:hover:bg-primary-700",
            "secondary": "border border-transparent bg-secondary text-white focus:ring-4 focus:ring-primary enabled:hover:bg-primary dark:bg-primary-600 dark:focus:ring-primary-800 dark:enabled:hover:bg-primary-700",
        ...
        "gradientDuoTone": {
            ...
            "purpleToOrange": "bg-gradient-to-br from-purple-600 to-orange-400 text-white focus:ring-4 focus:ring-orange-400 enabled:hover:bg-gradient-to-bl dark:focus:ring-cyan-800",
